...
var _vcdiff = _interopRequireDefault(__webpack_require__(46));
...
function decode(delta, source) {
  var vcdiff = new _vcdiff["default"](delta, source);
...
var _errors = _interopRequireDefault(__webpack_require__(157));
var TypedArray = _interopRequireWildcard(__webpack_require__(160));
var _integer = _interopRequireDefault(__webpack_require__(170));
var _delta = _interopRequireDefault(__webpack_require__(171));
var _near = _interopRequireDefault(__webpack_require__(174));
var _same = _interopRequireDefault(__webpack_require__(176));
 ...
 * @constructor
 */
var VCDiff = exports["default"] = /*#__PURE__*/function () {
  function VCDiff(delta, source) {
    _classCallCheck(this, VCDiff);
    this.delta = delta;
    this.position = 0;
    this.source = source;
  ...
  _createClass(VCDiff, [{
    ...
    key: "_consumeHeader",
    value: function _consumeHeader() {
      var hasVCDiffHeader = this.delta[0] === 214 &&
      // V
      this.delta[1] === 195 &&
      // C
      this.delta[2] === 196 &&
      ...
      if (!hasVCDiffHeader) {
        throw new _errors["default"].InvalidDelta('first 3 bytes not VCD');
      }
      var hdrIndicator = this.delta[4];
      // extract least significant bit
      var vcdDecompress = 1 & hdrIndicator;
      // extract second least significant bit
      var vcdCodetable = 1 & hdrIndicator >> 1;

      // verify not using Hdr_Indicator
      if (vcdDecompress || vcdCodetable) {
        throw new _errors["default"].NotImplemented('non-zero Hdr_Indicator (VCD_DECOMPRESS or VCD_CODETABLE bit is set)');
      }
      this.position += 5;
    }
  }, {
    key: "_consumeWindow",
    value: function _consumeWindow() {
      var winIndicator = this.delta[this.position++];

      // extract least significant bit
      var vcdSource = 1 & winIndicator;
      // extract second least significant bit
      var vcdTarget = 1 & winIndicator >> 1;
      if (vcdSource && vcdTarget) {
        throw new _errors["default"].InvalidDelta('VCD_SOURCE and VCD_TARGET cannot both be set in Win_Indicator');
      } else if (vcdSource) {
        var sourceSegmentLength, sourceSegmentPosition, deltaLength;
        var _deserializeInteger = (0, _integer["default"])(this.delta, this.position);
        sourceSegmentLength = _deserializeInteger.value;
        this.position = _deserializeInteger.position;
        var _deserializeInteger2 = (0, _integer["default"])(this.delta, this.position);
        sourceSegmentPosition = _deserializeInteger2.value;
        this.position = _deserializeInteger2.position;
        var _deserializeInteger3 = (0, _integer["default"])(this.delta, this.position);
        ...
        throw new _errors["default"].NotImplemented('non-zero VCD_TARGET in Win_Indicator');
      } else {
        var _deltaLength;
        var _deserializeInteger4 = (0, _integer["default"])(this.delta, this.position);
    ...
    function _buildTargetWindow(position, sourceSegment) {
      var window = (0, _delta["default"])(this.delta, position);
...
var Delta = /*#__PURE__*/function () {
  function Delta(U, UTargetPosition, data, addresses) {
    ...
    this.nearCache = new _near["default"](4);
    this.sameCache = new _same["default"](3);
  }
  _createClass(Delta, [{
    key: "getNextAddressInteger",
    value: function getNextAddressInteger() {
      var value;
      // get next address and increase the address position for the next address
      var _deserializeInteger5 = (0, _integer["default"])(this.addresses, this.addressesPosition);
      value = _deserializeInteger5.value;
      this.addressesPosition = _deserializeInteger5.position;
      return value;
    }
  }, {
    key: "getNextAddressByte",
    value: function getNextAddressByte() {
      // get next address and increase the address position for the next address
...
var defineWellKnownSymbol = __webpack_require__(48);
...
var InternalMetadataModule = __webpack_require__(75);
var collection = __webpack_require__(77);
var collectionWeak = __webpack_require__(89);
var isObject = __webpack_require__(15);
...
var redefineAll = __webpack_require__(74);
var getWeakData = __webpack_require__(75).getWeakData;
var anObject = __webpack_require__(21);
var isObject = __webpack_require__(15);
var anInstance = __webpack_require__(86);
var iterate = __webpack_require__(78);
var ArrayIterationModule = __webpack_require__(90);
var $has = __webpack_require__(16);
var InternalStateModule = __webpack_require__(26);
...
var arrayMethodUsesToLength = __webpack_require__(97);
...
var $ = __webpack_require__(2);
var fails = __webpack_require__(7);
var ArrayBufferModule = __webpack_require__(101);
var anObject = __webpack_require__(21);
var toAbsoluteIndex = __webpack_require__(42);
var toLength = __webpack_require__(40);
...
var global = __webpack_require__(3);
var DESCRIPTORS = __webpack_require__(6);
var NATIVE_ARRAY_BUFFER = __webpack_require__(102);
var createNonEnumerableProperty = __webpack_require__(19);
var redefineAll = __webpack_require__(74);
var fails = __webpack_require__(7);
var anInstance = __webpack_require__(86);
...
var createTypedArrayConstructor = __webpack_require__(108);
...
var global = __webpack_require__(3);
var DESCRIPTORS = __webpack_require__(6);
var TYPED_ARRAYS_CONSTRUCTORS_REQUIRES_WRAPPERS = __webpack_require__(109);
...
var toLength = __webpack_require__(40);
var toIndex = __webpack_require__(103);
var toOffset = __webpack_require__(111);
var toPrimitive = __webpack_require__(14);
var has = __webpack_require__(16);
var classof = __webpack_require__(83);
var isObject = __webpack_require__(15);
...
var setPrototypeOf = __webpack_require__(67);
var getOwnPropertyNames = __webpack_require__(37).f;
var typedArrayFrom = __webpack_require__(113);
...
var fails = __webpack_require__(7);
var checkCorrectnessOfIteration = __webpack_require__(87);
var NATIVE_ARRAY_BUFFER_VIEWS = __webpack_require__(110).NATIVE_ARRAY_BUFFER_VIEWS;
...
var toPositiveInteger = __webpack_require__(112);
...
var isArrayIteratorMethod = __webpack_require__(79);
var bind = __webpack_require__(80);
var aTypedArrayConstructor = __webpack_require__(110).aTypedArrayConstructor;
...
var ArrayBufferViewCore = __webpack_require__(110);
var $copyWithin = __webpack_require__(116);
...
var exportTypedArrayMethod = __webpack_require__(110).exportTypedArrayMethod;
var fails = __webpack_require__(7);
var global = __webpack_require__(3);
...
var fails = __webpack_require__(7);
var wellKnownSymbol = __webpack_require__(50);
var V8_VERSION = __webpack_require__(143);
...
var createNonEnumerableProperty = __webpack_require__(19);
var dateToPrimitive = __webpack_require__(150);
var wellKnownSymbol = __webpack_require__(50);
...
var requireObjectCoercible = __webpack_require__(13);
var whitespaces = __webpack_require__(156);
...
var _default = exports["default"] = /* @__PURE__ */CustomErrors(['NotImplemented', 'InvalidDelta']);
...
var TypedArrayList = exports.TypedArrayList = /*#__PURE__*/function () {
  function TypedArrayList() {
    _classCallCheck(this, TypedArrayList);
    this.typedArrays = [];
    this.startIndexes = [];
    this.length = 0;
  }
  _createClass(TypedArrayList, [{
    key: "add",
    value: function add(typedArray) {
...
var _errors = _interopRequireDefault(__webpack_require__(157));
var _integer = _interopRequireDefault(__webpack_require__(170));
var _tokenize_instructions = _interopRequireDefault(__webpack_require__(172));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
function delta(delta, position) {
  var targetWindowLength, dataLength, instructionsLength, addressesLength;

  // parentheses are needed for assignment destructuring
  // Delta_Indicator byte
  var _deserializeInteger = (0, _integer["default"])(delta, position);
  targetWindowLength = _deserializeInteger.value;
  position = _deserializeInteger.position;
  if (delta[position] !== 0) {
    throw new _errors["default"].NotImplemented('VCD_DECOMPRESS is not supported, Delta_Indicator must be zero at byte ' + position + ' and not ' + delta[position]);
  }
  position++;
  var _deserializeInteger2 = (0, _integer["default"])(delta, position);
  dataLength = _deserializeInteger2.value;
  position = _deserializeInteger2.position;
  var _deserializeInteger3 = (0, _integer["default"])(delta, position);
  instructionsLength = _deserializeInteger3.value;
  position = _deserializeInteger3.position;
  var _deserializeInteger4 = (0, _integer["default"])(delta, position);
  ...
  var deserializedInstructions = (0, _tokenize_instructions["default"])(instructions);
...
exports["default"] = tokenizeInstructions;
var _instructions = _interopRequireDefault(__webpack_require__(173));
var _integer = _interopRequireDefault(__webpack_require__(170));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
function tokenizeInstructions(instructionsBuffer) {
  ...
  while (instructionsPosition < instructionsBuffer.length) {
    ...
    var addSize = void 0,
      ...
      size = void 0;
    if (index === 0) {
      var _deserializeInteger = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger.value;
      instructionsPosition = _deserializeInteger.position;
      deserializedInstructions.push(new _instructions["default"].RUN(size));
    } else if (index === 1) {
      var _deserializeInteger2 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger2.value;
      instructionsPosition = _deserializeInteger2.position;
      deserializedInstructions.push(new _instructions["default"].ADD(size));
    } else if (index < 19) {
      deserializedInstructions.push(new _instructions["default"].ADD(index - 1));
    } else if (index === 19) {
      var _deserializeInteger3 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger3.value;
      instructionsPosition = _deserializeInteger3.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 0));
    } else if (index < 35) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 16, 0));
    } else if (index === 35) {
      var _deserializeInteger4 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger4.value;
      instructionsPosition = _deserializeInteger4.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 1));
    } else if (index < 51) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 32, 1));
    } else if (index === 51) {
      var _deserializeInteger5 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger5.value;
      instructionsPosition = _deserializeInteger5.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 2));
    } else if (index < 67) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 48, 2));
    } else if (index === 67) {
      var _deserializeInteger6 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger6.value;
      instructionsPosition = _deserializeInteger6.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 3));
    } else if (index < 83) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 64, 3));
    } else if (index === 83) {
      var _deserializeInteger7 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger7.value;
      instructionsPosition = _deserializeInteger7.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 4));
    } else if (index < 99) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 80, 4));
    } else if (index === 99) {
      var _deserializeInteger8 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger8.value;
      instructionsPosition = _deserializeInteger8.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 5));
    } else if (index < 115) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 96, 5));
    } else if (index === 115) {
      var _deserializeInteger9 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger9.value;
      instructionsPosition = _deserializeInteger9.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 6));
    } else if (index < 131) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 112, 6));
    } else if (index === 131) {
      var _deserializeInteger10 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger10.value;
      instructionsPosition = _deserializeInteger10.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 7));
    } else if (index < 147) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 128, 7));
    } else if (index === 147) {
      var _deserializeInteger11 = (0, _integer["default"])(instructionsBuffer, instructionsPosition);
      size = _deserializeInteger11.value;
      instructionsPosition = _deserializeInteger11.position;
      deserializedInstructions.push(new _instructions["default"].COPY(size, 8));
    } else if (index < 163) {
      deserializedInstructions.push(new _instructions["default"].COPY(index - 144, 8));
    } else if (index < 175) {
      var _ADD_COPY = ADD_COPY(index, 163);
      addSize = _ADD_COPY.addSize;
      copySize = _ADD_COPY.copySize;
      deserializedInstructions.push(new _instructions["default"].ADD(addSize));
      deserializedInstructions.push(new _instructions["default"].COPY(copySize, 0));
    } else if (index < 187) {
      var _ADD_COPY2 = ADD_COPY(index, 175);
      addSize = _ADD_COPY2.addSize;
      copySize = _ADD_COPY2.copySize;
      deserializedInstructions.push(new _instructions["default"].ADD(addSize));
      deserializedInstructions.push(new _instructions["default"].COPY(copySize, 1));
    } else if (index < 199) {
      var _ADD_COPY3 = ADD_COPY(index, 187);
      addSize = _ADD_COPY3.addSize;
      copySize = _ADD_COPY3.copySize;
      deserializedInstructions.push(new _instructions["default"].ADD(addSize));
      deserializedInstructions.push(new _instructions["default"].COPY(copySize, 2));
    } else if (index < 211) {
      var _ADD_COPY4 = ADD_COPY(index, 199);
      addSize = _ADD_COPY4.addSize;
      copySize = _ADD_COPY4.copySize;
      deserializedInstructions.push(new _instructions["default"].ADD(addSize));
      deserializedInstructions.push(new _instructions["default"].COPY(copySize, 3));
    } else if (index < 223) {
      var _ADD_COPY5 = ADD_COPY(index, 211);
      addSize = _ADD_COPY5.addSize;
      copySize = _ADD_COPY5.copySize;
      deserializedInstructions.push(new _instructions["default"].ADD(addSize));
      deserializedInstructions.push(new _instructions["default"].COPY(copySize, 4));
    } else if (index < 235) {
      var _ADD_COPY6 = ADD_COPY(index, 223);
      addSize = _ADD_COPY6.addSize;
      copySize = _ADD_COPY6.copySize;
      deserializedInstructions.push(new _instructions["default"].ADD(addSize));
      deserializedInstructions.push(new _instructions["default"].COPY(copySize, 5));
    } else if (index < 239) {
      deserializedInstructions.push(new _instructions["default"].ADD(index - 235 + 1));
      deserializedInstructions.push(new _instructions["default"].COPY(4, 6));
    } else if (index < 243) {
      deserializedInstructions.push(new _instructions["default"].ADD(index - 239 + 1));
      deserializedInstructions.push(new _instructions["default"].COPY(4, 7));
    } else if (index < 247) {
      deserializedInstructions.push(new _instructions["default"].ADD(index - 243 + 1));
      deserializedInstructions.push(new _instructions["default"].COPY(4, 8));
    } else if (index < 256) {
      deserializedInstructions.push(new _instructions["default"].COPY(4, index - 247));
      deserializedInstructions.push(new _instructions["default"].ADD(1));
    } else {
...
function ADD_COPY(index, baseIndex) {
  ...
  // 0,1,2 -> 0   3,4,5 -> 1   etc.
  var addSizeIndex = Math.floor(zeroBased / 3);
  // offset so size starts at 1
  var addSize = addSizeIndex + 1;

  // rotate through 0, 1, and 2
  var copySizeIndex = zeroBased % 3;
...
var ADD = /*#__PURE__*/function () {
  function ADD(size) {
    ...
    _defineProperty(this, "name", 'ADD');
    this.size = size;
  }
  _createClass(ADD, [{
    key: "execute",
    value: function execute(delta) {
...
var COPY = /*#__PURE__*/function () {
  function COPY(size, mode) {
    ...
    _defineProperty(this, "name", 'COPY');
    this.size = size;
    this.mode = mode;
  }
  _createClass(COPY, [{
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var NearCache = exports["default"] = /*#__PURE__*/function () {
  function NearCache(size) {
    _classCallCheck(this, NearCache);
    this.size = size;
    this.near = new Array(this.size).fill(0);
    this.nextSlot = 0;
  }
  _createClass(NearCache, [{
    key: "update",
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var SameCache = exports["default"] = /*#__PURE__*/function () {
  function SameCache(size) {
    _classCallCheck(this, SameCache);
    this.size = size;
    this.same = new Array(this.size * 256).fill(0);
  }
  _createClass(SameCache, [{
    key: "update",
    value: function update(address) {
